...
instance Print AbsJavalette.Prog where
  prt i e = case e of
    AbsJavalette.Program funs -> prPrec i 0 (concatD [prt 0 funs])
...
instance Print AbsJavalette.Expr where
  prt i e = case e of
    AbsJavalette.Evar id -> prPrec i 6 (concatD [prt 0 id])
    ...
    AbsJavalette.EAPP id exprs -> prPrec i 6 (concatD [prt 0 id, doc (showString "("), prt 0 exprs, doc (showString ")")])
